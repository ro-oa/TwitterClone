    ...
    <div class="main">
      ...
      <div class="tweet-post">
        ...
        <div class="input-area">
          <form action="post.php" method="post" enctype="multipart/form-data"><!-- enctype="multipart/form-data"は画像ファイルを送るときに使う -->
            <textarea name="body" placeholder="今どうしてる？" max-length="140"></textarea>
            <div class="bottom-area">
              <div class="mb-0">
                <input type="file" name="image" class="form-control form-control-sm">
              </div>
              <button class="btn" type="submit">つぶやく</button> <!-- タイプ属性は入力された内容を送信したいのでsubmit -->
